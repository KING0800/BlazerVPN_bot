...
from bot.keyboards.user_keyboards import profile_keyboard, help_kb, balance_handle_keyboard, start_kb_handle, device_keyboard, support_to_moders, replenishment_balance, back_keyboard, support_keyboard, location_keyboard, buy_keyboard, addind_count_for_extend, extend_keyboard, numbers_for_replenishment
from bot.keyboards.adm_keyboards import about_yourself_to_add_keyboard, about_yourself_to_delete_keyboard

from bot.database.UserData import get_balance, get_referrer_info, find_user_data
...
async def handle_text(message: Message, state):
    ...
    if message.text == "/help":
        ...
        await message.answer_photo(photo="https://imgur.com/tjRqQST", caption=f"• 👤 <b>Ваш профиль</b>:\n\n"
                                                                f"ID: <code>{id}</code>\n"
